...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libdata.a

dist/Debug/GNU-Linux-x86/libdata.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${RM} dist/Debug/GNU-Linux-x86/libdata.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdata.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug/GNU-Linux-x86/libdata.a
...
${TESTDIR}/tests/mainDataTest.o: tests/mainDataTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mainDataTest.o tests/mainDataTest.cpp


${TESTDIR}/tests/mainDataTestRunner.o: tests/mainDataTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mainDataTestRunner.o tests/mainDataTestRunner.cpp
