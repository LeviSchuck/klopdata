...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libklopdata.a

dist/Debug/GNU-Linux-x86/libklopdata.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${RM} dist/Debug/GNU-Linux-x86/libklopdata.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libklopdata.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug/GNU-Linux-x86/libklopdata.a
...
${TESTDIR}/tests/mainDataTest.o: tests/mainDataTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mainDataTest.o tests/mainDataTest.cpp


${TESTDIR}/tests/mainDataTestRunner.o: tests/mainDataTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/mainDataTestRunner.o tests/mainDataTestRunner.cpp
